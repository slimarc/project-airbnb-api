...
public class AcomodacaoRequest {
    ...
    public AcomodacaoRequest(int id_item, double valor_diaria, int max_pessoas, Endereco endereco, Locador locador,
            String descricao) {
    ...
    public boolean equals(Object obj) {
        ...
        AcomodacaoRequest that = (AcomodacaoRequest) obj;
    ...
    public String toString() {
        return "AcomodacaoRequest [id_item=" + id_item + ", valor_diaria=" + valor_diaria + ", max_pessoas=" + max_pessoas
