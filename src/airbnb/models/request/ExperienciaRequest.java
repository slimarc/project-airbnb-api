...
public class ExperienciaRequest {
    ...
    public ExperienciaRequest(int id_item, double valor_diaria, int max_pessoas, Endereco endereco, Locador locador,
            String descricao) {
    ...
    public boolean equals(Object obj) {
        ...
        ExperienciaRequest that = (ExperienciaRequest) obj;
    ...
    public String toString() {
        return "ExperienciaRequest [id_item=" + id_item + ", valor_diaria=" + valor_diaria + ", max_pessoas="
                + max_pessoas + ", endereco=" + endereco + ", locador=" + locador + ", descricao=" + descricao + "]";
    }
